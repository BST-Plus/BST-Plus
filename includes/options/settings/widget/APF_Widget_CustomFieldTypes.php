...
class APF_Widget_CustomFieldTypes extends AdminPageFramework_Widget {
    ...
    public function start() {
        ...
        if ( $this->oProp->bIsAdmin ) {
            ...
            $_aFiles         = array(
                $_sPluginDirName . '/library/third-party/date-time-custom-field-types/DateTimeCustomFieldType.php',
                $_sPluginDirName . '/library/third-party/dial-custom-field-type/DialCustomFieldType.php',
                $_sPluginDirName . '/library/third-party/autocomplete-custom-field-type/AutocompleteCustomFieldType.php',     
            );
