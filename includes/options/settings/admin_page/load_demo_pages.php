...
include( APFDEMO_DIRNAME . '/settings/admin_page/APF_Demo.php' );
new APF_Demo( 
    ...
    include( APFDEMO_DIRNAME . '/settings/admin_page/APF_Demo_CustomFieldTypes.php' ); 
    ...
    include( APFDEMO_DIRNAME . '/settings/admin_page/APF_Demo_ManageOptions.php' );
    ...
    include( APFDEMO_DIRNAME . '/settings/admin_page/APF_Demo_HiddenPage.php' );
    new APF_Demo_HiddenPage;
    
    // Add the readme and the documentation sub-menu items to the above main demo plugin root page.
    include( APFDEMO_DIRNAME . '/settings/admin_page/APF_Demo_Readme.php' );
    new APF_Demo_Readme(
    ...
    include( APFDEMO_DIRNAME . '/settings/admin_page/APF_Demo_Tool.php' );
    new APF_Demo_Tool(
        '',
        APFDEMO_FILE,
        'read',
    ...
    include( APFDEMO_DIRNAME . '/settings/admin_page/APF_Demo_Contact.php' );
