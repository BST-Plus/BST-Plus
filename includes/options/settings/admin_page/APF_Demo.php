...
class APF_Demo extends AdminPageFramework {
    ...
    public function setUp() { // this method automatically gets triggered with the wp_loaded hook. 
        ...
        include( APFDEMO_DIRNAME . '/settings/admin_page/builtin_field_type/APF_Demo_BuiltinFieldTypes_Text.php' );
        new APF_Demo_BuiltinFieldTypes_Text;
        include( APFDEMO_DIRNAME . '/settings/admin_page/builtin_field_type/APF_Demo_BuiltinFieldTypes_Selector.php' );
        new APF_Demo_BuiltinFieldTypes_Selector;
        include( APFDEMO_DIRNAME . '/settings/admin_page/builtin_field_type/APF_Demo_BuiltinFieldTypes_File.php' );
        new APF_Demo_BuiltinFieldTypes_File( $_sClassName );
        include( APFDEMO_DIRNAME . '/settings/admin_page/builtin_field_type/APF_Demo_BuiltinFieldTypes_Checklist.php' );
        new APF_Demo_BuiltinFieldTypes_Checklist;
        include( APFDEMO_DIRNAME . '/settings/admin_page/builtin_field_type/APF_Demo_BuiltinFieldTypes_MISC.php' );
        new APF_Demo_BuiltinFieldTypes_MISC;
        include( APFDEMO_DIRNAME . '/settings/admin_page/builtin_field_type/APF_Demo_BuiltinFieldTypes_Verification.php' );
        new APF_Demo_BuiltinFieldTypes_Verification( $_sClassName );
        include( APFDEMO_DIRNAME . '/settings/admin_page/builtin_field_type/APF_Demo_BuiltinFieldTypes_Mixed.php' );
        new APF_Demo_BuiltinFieldTypes_Mixed;
        include( APFDEMO_DIRNAME . '/settings/admin_page/builtin_field_type/APF_Demo_BuiltinFieldTypes_Sections.php' );
        new APF_Demo_BuiltinFieldTypes_Sections;
        include( APFDEMO_DIRNAME . '/settings/admin_page/builtin_field_type/APF_Demo_BuiltinFieldTypes_Callbacks.php' );
        new APF_Demo_BuiltinFieldTypes_Callbacks;
        include( APFDEMO_DIRNAME . '/settings/admin_page/builtin_field_type/APF_Demo_BuiltinFieldTypes_System.php' );
