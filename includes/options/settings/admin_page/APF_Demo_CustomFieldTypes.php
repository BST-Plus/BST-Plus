...
class APF_Demo_CustomFieldTypes extends AdminPageFramework {
    ...
    public function setUp() { // this method automatically gets triggered with the wp_loaded hook. 
        ...
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_Date.php' );
        new APF_Demo_CustomFieldTypes_Date;
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_Geometry.php' );
        new APF_Demo_CustomFieldTypes_Geometry;
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_Dial.php' );
        new APF_Demo_CustomFieldTypes_Dial;
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_Font.php' );
        new APF_Demo_CustomFieldTypes_Font;
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_Sample.php' );
        new APF_Demo_CustomFieldTypes_Sample;
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_Revealer.php' );
        new APF_Demo_CustomFieldTypes_Revealer;
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_Grid.php' );
        new APF_Demo_CustomFieldTypes_Grid;
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_AutoComplete.php' );
        new APF_Demo_CustomFieldTypes_AutoComplete;
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_Link.php' );
        new APF_Demo_CustomFieldTypes_Link;
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_GitHub.php' );
        new APF_Demo_CustomFieldTypes_GitHub;
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_ImageSelectors.php' );
        new APF_Demo_CustomFieldTypes_ImageSelectors;                
        include( APFDEMO_DIRNAME . '/settings/admin_page/custom_field_type/APF_Demo_CustomFieldTypes_ACE.php' );
