...
class APF_Demo_CustomFieldTypes_Date {
    ...
    public function __construct( $sClassName='', $sPageSlug='', $sTabSlug='' ) {
        ...
        private function registerFieldTypes( $sClassName ) {
            ...
            include( $_sPluginDirName . '/library/third-party/date-time-custom-field-types/DateCustomFieldType.php' );
            include( $_sPluginDirName . '/library/third-party/date-time-custom-field-types/TimeCustomFieldType.php' );
            include( $_sPluginDirName . '/library/third-party/date-time-custom-field-types/DateTimeCustomFieldType.php' );
            include( $_sPluginDirName . '/library/third-party/date-time-custom-field-types/DateRangeCustomFieldType.php' );
            include( $_sPluginDirName . '/library/third-party/date-time-custom-field-types/DateTimeRangeCustomFieldType.php' );
            include( $_sPluginDirName . '/library/third-party/date-time-custom-field-types/TimeRangeCustomFieldType.php' );
            include( $_sPluginDirName . '/library/third-party/reset-custom-field-type/ResetCustomFieldType.php' );
