...
class APF_Demo_CustomFieldTypes_ImageSelectors {
    ...
    public function __construct( $sClassName='', $sPageSlug='', $sTabSlug='' ) {
        ...
        private function registerFieldTypes( $sClassName ) {
            ...
            include( $_sPluginDirName . '/library/third-party/image_checkbox-custom-field-type/ImageCheckboxCustomFieldType.php' );
            include( $_sPluginDirName . '/library/third-party/image_radio-custom-field-type/ImageRadioCustomFieldType.php' );
